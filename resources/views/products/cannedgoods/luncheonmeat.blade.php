...
@section('titlePage', 'LegaShop | Luncheon Meat');
@section('content')
...
<div class="container product">
    <div class="row product-container">
        @foreach($productsLuncheonMeats as $productsLuncheonMeat)
            <div class="col-md-3 product-col" data-id="{{$productsLuncheonMeat->id}}">
                <a class="link-details" href="{{url('/products/product-details/'.$productsLuncheonMeat->id)}}">
                <div class="card">
                    <div class="card-body">
                        <img src="{{asset('uploads/product_images/'.$productsLuncheonMeat->product_image)}}" class="product-img">
                        <div class="product-info-container">
                            <p class="card-title mt-4">&#8369; <b id="price-product">{{$productsLuncheonMeat->product_price}}.50</b></p>
                            <p class="card-name">{{$productsLuncheonMeat->product_name}}</p></a>
                            <p class="card-category">{{$productsLuncheonMeat->category_name}}</p>
        ...
        @endforeach
        {{$productsLuncheonMeats->links('/vendor/pagination/products-pagination')}}
    </div>  
</div>
