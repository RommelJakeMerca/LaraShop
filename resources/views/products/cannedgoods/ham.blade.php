...
@section('titlePage', 'LegaShop | Ham');
@section('content')
...
<div class="container product">
    <div class="row product-container">
        @foreach($productsHams as $productsHam)
            <div class="col-md-3 product-col" data-id="{{$productsHam->id}}">
                <a class="link-details" href="{{url('/products/product-details/'.$productsHam->id)}}">
                <div class="card">
                    <div class="card-body">
                        <img src="{{asset('uploads/product_images/'.$productsHam->product_image)}}" class="product-img">
                        <div class="product-info-container">
                            <p class="card-title mt-4">&#8369; <b id="price-product">{{$productsHam->product_price}}.00</b></p>
                            <p class="card-name">{{$productsHam->product_name}}</p></a>
                            <p class="card-category">{{$productsHam->category_name}}</p>
        ...
        @endforeach
        {{$productsHams->links('/vendor/pagination/products-pagination')}}
    </div>  
</div>
