...
@section('titlePage', 'LegaShop | Laundry');
@section('content')
...
<div class="container product">
    <div class="row product-container">
        @foreach($productsLaundries as $productsLaundry)
            <div class="col-md-3 product-col" data-id="{{$productsLaundry->id}}">
                <a class="link-details" href="{{url('/products/product-details/'.$productsLaundry->id)}}">
                <div class="card">
                    <div class="card-body">
                        <img src="{{asset('uploads/product_images/'.$productsLaundry->product_image)}}" class="product-img">
                        <div class="product-info-container">
                            <p class="card-title mt-4">&#8369; <b id="price-product">{{$productsLaundry->product_price}}.00</b></p>
                            <p class="card-name">{{$productsLaundry->product_name}}</p></a>
                            <p class="card-category">{{$productsLaundry->category_name}}</p>
        ...
        @endforeach
        {{$productsLaundries->links('/vendor/pagination/products-pagination')}}
    </div>  
</div>
