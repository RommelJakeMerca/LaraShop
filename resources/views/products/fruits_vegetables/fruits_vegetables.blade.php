...
@section('titlePage', 'LegaShop | Fruits & Vegetables');
@section('content')
...
<div class="container img-container">
    <img class="rounded img-rice" src="{{asset('products_asset/images/cover-images/fruits&vegetables-cover.jpg')}}">
    <p class="text-categories-fv">FRUITS & VEGETABLES</p>
</div>
...
<div class="container mt-4">
    <form action="{{route('filterFruitsVegetables')}}" method="POST">
        @csrf
...
<div class="container product">
    <div class="row product-container">
        @foreach ($productsFruitsVegetables as $productsFruitsVegetable)
            <div class="col-md-3 product-col" data-id="{{$productsFruitsVegetable->id}}">
                <a class="link-details" href="{{url('/products/product-details/'.$productsFruitsVegetable->id)}}">
                <div class="card">
                    <div class="card-body">
                        <img src="{{asset('uploads/product_images/'.$productsFruitsVegetable->product_image)}}" class="product-img">
                        <div class="product-info-container">
                            <p class="card-title mt-4">&#8369; <b id="price-product">{{$productsFruitsVegetable->product_price}}.00</b></p>
                            <p class="card-name">{{$productsFruitsVegetable->product_name}}</p></a>
                            <p class="card-category">{{$productsFruitsVegetable->category_name}}</p>
        ...
        @endforeach
        {{$productsFruitsVegetables->links('/vendor/pagination/products-pagination')}}
    </div>  
</div>
